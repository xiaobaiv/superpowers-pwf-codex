...
$(command -v python3 || command -v python) <plugin-root>/skills/planning-with-files/scripts/session-catchup.py "$(pwd)"
```

```powershell
# Windows PowerShell
python "<plugin-root>\skills\planning-with-files\scripts\session-catchup.py" (Get-Location)
```
...
- **Templates** are in this plugin's `skills/planning-with-files/templates/`
- **Your planning files** go in **your project directory**

| Location | What Goes There |
|----------|-----------------|
| Skill directory (`skills/planning-with-files/` inside this plugin) | Templates, scripts, reference docs |
